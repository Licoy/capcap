...
final class PinWindowInteractionTests: XCTestCase {
    ...
    func testPinToolbarProvidesCopyAndDragWithoutMoveControl() throws {
        ...
        XCTAssertTrue(labels.contains(L10n.pinClickThrough))
    ...
    func testPinToolbarHidesOptionalButtonsFromLeftToRight() {
        ...
        assertVisiblePinToolbarItems(
            in: toolbar,
            width: 191,
            optionalLabels: [L10n.tipOCR, L10n.pinToolbarCopy, L10n.pinClickThrough]
        )
        assertVisiblePinToolbarItems(
            in: toolbar,
            width: 163,
            optionalLabels: [L10n.pinToolbarCopy, L10n.pinClickThrough]
        )
        assertVisiblePinToolbarItems(
            in: toolbar,
            width: 135,
            optionalLabels: [L10n.pinClickThrough]
        )
        assertVisiblePinToolbarItems(
            in: toolbar,
            width: 107,
